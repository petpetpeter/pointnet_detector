...
f_scale_down_xyz = h5py.File(f'{OUTPUT_DIR}/d0.h5','w')
f_scale_up_xyz = h5py.File(f'{OUTPUT_DIR}/d1.h5','w')
f_light_up_colors = h5py.File(f'{OUTPUT_DIR}/d2.h5','w')
f_light_down_colors = h5py.File(f'{OUTPUT_DIR}/d3.h5','w')
f_random_rotate = h5py.File(f'{OUTPUT_DIR}/d4.h5','w')
f_random_rotate_for_testing = h5py.File(f'{OUTPUT_DIR}/d5.h5','w')
...
log_file.write(f"number of frames: {len(data)}")