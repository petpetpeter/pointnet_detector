...
INPUT_DIR = '/home/peter/Documents/py_workspace/PointNet_Custom_Object_Detection/input'
OUTPUT_DIR = f'{INPUT_DIR}/ply/'
...
def pcd2ply(input_filename, output_filename):
    ...
    o3d.io.write_point_cloud(output_filename, plydata, write_ascii=True)
...
if __name__ == '__main__':
    ...
    for pointcloud in pointcloud_list:
        ...
        output_filename = os.path.join(OUTPUT_DIR, pointcloud.split('.')[0] + '.ply')
        pcd2ply(input_filename, output_filename)
